...
<div class="container" style="color: white; margin-top: 10rem">
    <div class="row">
            @foreach ($locations as $location) 
            <div class="my-4 col-lg-4 col-sm-6">
                <div class="card" style="width: 18rem; overflow: hidden">
                    <span class="fi fi-{{$location->country}}" style="font-size: 14rem; text-align: center; padding: 1rem;"></span>
